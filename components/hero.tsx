...
export function Hero({ onRegisterClick }: { onRegisterClick?: () => void }) {
  ...
  return (
    <section className="hero-bg relative w-full min-h-screen overflow-visible flex flex-col">
      {/* Background */}
      <div
        ref={containerRef}
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 py-20 sm:py-24 md:py-0 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex flex-col justify-center gap-6">
          ...
          <p className="text-pretty text-base md:text-lg text-muted-foreground">
            A futuristic, minimal community for developers. Events, projects,
            chat, and more—designed for speed and clarity.
          </p>
        </div>
            ...
            <div className="glass rounded-2xl p-6 w-full glass border-gradient">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Join us for a weekend of coding, collaboration, and fun! Open
                  to all skill levels.
                </p>
                <GlowButton
